...
if($mail_contacto!="" and $asunto!="" and $mensaje!="" and $user!=""){
	$enviado_ok=$las_webs->envia_mail_anuncio($user,$mail_contacto,$asunto,$mensaje,$codan);
	sleep(1);
...
<?php
if($enviado_ok)
	echo "<div id='enviado_ok_anuncio'>
		  	Tu mensaje se ha enviado!<br />
			En breve recibiras respuesta del vendedor.
		  </div>";
else
	echo "<div id='enviado_error_anuncio'>
			Parece que ha habido un error!<br />
			Estamos tratando de solucionar el problema
	      </div>";
?>
