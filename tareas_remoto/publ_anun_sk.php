...
$post_data = 'username=negotiable kite&password=000177&autologin=on&viewonline=on&redirect=index.php&sid=e34ddb9787b3b3dc6ac59e63b341a80b&login=Login';
...
for($i=0;$i<count($datos_anuncio);$i++){
	...
	$mensaje = "[b][url=".$link."]".$asunto."[/url][/b]
	 ...
	 [img]".$imagen."[/img]";
	  ...
	  $post_data = 'subject='.$asunto.'&message='.$mensaje.'&attach_sig=on&notify=on&mode=newtopic&f=1&post=Enviar';
