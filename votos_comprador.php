...
if(!isset($_GET['user'])) $user="";
	...
	$num_filas_vendedor=$las_webs->votos_totales_comprador($cod_usuario);
	//no pongo num_filas_vendedor para aprovechar el mismo codigo que uso en votos_vendedor.php
}
?>
...
<?php include("cabecera.php");?>
	...
	<div id="contenedor_users" class="voto">
		<div id="tit_users_voto">Lista de votos de <?php echo $user; ?> como comprador</div>
