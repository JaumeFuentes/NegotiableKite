			...
			function(data){	
				...
				if(data=='Mensaje Enviado!') 
					$('#contactform').slideUp(3000,
						function(){
							$('.form_contacto').
							html('<span style="color:#666; font-size:14px; font-family:Arial Black;">GRACIAS POR CONTACTAR,<br/>EN BREVE EL USUARIO SE PONDRA EN CONTACTO CONTIGO</span><br/><br/><span style="color:#666;">Buen Viento!</span>')
						}
					);		
			}	
		);	
