				...
				<div style="float:left">
					<table>
						...
						<tr>
							<td>
						  <td align="center">
									<a style="text-decoration:none; color:#666666;" id="remove_image_1" href="#" onclick="borrar('ver1'); return false;">Eliminar</a>
						  </td>
							</td>
						</tr>
					</table>
				...
				<div style="float:left">
					<table>
						...
						<tr>
							<td>
						  <td align="center">
									<a style="text-decoration:none; color:#666666;" class="remove_image" id="remove_image_2" href="#" onclick="borrar('ver2'); return false;">Eliminar</a>
						  </td>
							</td>
						</tr>
					</table>
				...
				<div style="float:left">
					<table>
						...
						<tr>
							<td>
						  <td align="center">
									<a style="text-decoration:none; color:#666666;" class="remove_image" id="remove_image_3" href="#" onclick="borrar('ver3'); return false;">Eliminar</a>
						  </td>
							</td>
						</tr>
					</table>
				...
				<div style="float:left">
					<table>
						...
						<tr>
							<td>
						  <td align="center">
									<a style="text-decoration:none; color:#666666;" class="remove_image" id="remove_image_4" href="#" onclick="borrar('ver4'); return false;">Eliminar</a>
						  </td>
							</td>
						</tr>
					</table>
