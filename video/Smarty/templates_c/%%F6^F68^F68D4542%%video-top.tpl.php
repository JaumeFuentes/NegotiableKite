<?php /* Smarty version 2.6.20, created on 2013-03-24 22:13:52
    ...
    <div class="container-fluid">
      <div class="row-fluid">
		...
		<?php if ($this->_tpl_vars['cat_name']): ?>
			<h1 class="entry-title"><?php echo $this->_tpl_vars['cat_name']; ?>
 <?php echo $this->_tpl_vars['lang']['top_m_videos']; ?>
</h1>
		<?php else: ?>
			<h1 class="entry-title"><?php echo $this->_tpl_vars['lang']['top_m_videos']; ?>
</h1>
		<?php endif; ?>
...
"><?php echo $this->_tpl_vars['video_data']['author_name']; ?>
			        ...
			        <span class="pm-video-attr-since"><?php echo $this->_tpl_vars['lang']['added']; ?>
