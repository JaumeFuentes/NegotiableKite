<?php /* Smarty version 2.6.20, created on 2013-03-24 22:11:22
...
"><i class="icon-info-sign"></i></a></span>
                ...
                <div class="">
                  <div class="controls">
                    <input class="btn btn-success" name="Submit" id="Submit" value="<?php echo $this->_tpl_vars['lang']['submit_submit']; ?>
" type="submit" data-loading-text="<?php echo $this->_tpl_vars['lang']['submit_send']; ?>
"> <span class="hide" id="loading-gif-bottom"><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ajax-loading.gif" width="" height="" alt=""></span>
                  </div>
                </div>
