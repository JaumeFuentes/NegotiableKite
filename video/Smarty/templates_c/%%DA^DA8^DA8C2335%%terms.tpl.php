<?php /* Smarty version 2.6.20, created on 2013-03-24 22:14:58
         compiled from terms.tpl */ ?>
<h1><?php echo @_SITENAME; ?>
 <?php echo $this->_tpl_vars['lang']['toa']; ?>
</h1>
<hr />
<h2>Code of Conduct</h2>
<p>In using the <?php echo @_SITENAME; ?>
 Service, you must behave in a civil and respectful manner at all times. Further, you will not:</p>
<ul>
    ...
    <li>Advertise or solicit others to purchase any product or service within the <?php echo @_SITENAME; ?>
 Site (unless you are an official <?php echo @_SITENAME; ?>
 partner or advertiser and have a written agreement with <?php echo @_SITENAME; ?>
).</li>
</ul>
<p><?php echo @_SITENAME; ?>
 has the right, but not the obligation, to monitor all conduct on and content submitted to the <?php echo @_SITENAME; ?>
 Service.</p>
<hr />
<h2>Membership</h2>
<p>REGISTRATION: To fully use the <?php echo @_SITENAME; ?>
 Service, you must register as a member by providing a user name, password, and valid email address. You must provide complete and accurate registration information to <?php echo @_SITENAME; ?>
 and notify us if your information changes. If you are a business, government, or non-profit entity, the person whose email address is associated with the account must have the authority to bind the entity to this Agreement.</p>
...
<p>ACCOUNT SECURITY: You are responsible for all activity that occurs under your account, including any activity by unauthorized users. You must not allow others to use your account. You must safeguard the confidentiality of your password. If you are using a computer that others have access to, you must log out of your account after using the <?php echo @_SITENAME; ?>
 Service.</p>
<hr />
