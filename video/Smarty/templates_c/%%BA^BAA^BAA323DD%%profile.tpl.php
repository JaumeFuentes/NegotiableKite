<?php /* Smarty version 2.6.20, created on 2013-03-24 22:28:14
...
/img/ico_social_site.png" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['profile_social_website']; ?>
" border="0"> <?php echo $this->_tpl_vars['social_website']; ?>
</a></li>
			<?php else: ?>
				<li><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ico_social_site.png" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['profile_social_website']; ?>
" border="0" class="ico-social-none"> n/a</li>
			<?php endif; ?> 
...
" target="_blank"><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ico_social_fb.png" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['profile_social_fb']; ?>
" border="0"> <?php echo $this->_tpl_vars['social_facebook']; ?>
</a></li>
			<?php else: ?>
				<li><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ico_social_fb.png" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['profile_social_website']; ?>
" border="0" class="ico-social-none"> n/a</li>
			<?php endif; ?>
...
" target="_blank"><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ico_social_twitter.png" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['profile_social_twitter']; ?>
" border="0"> <?php echo $this->_tpl_vars['social_twitter']; ?>
</a></li>
			<?php else: ?>
				<li><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
...
" target="_blank"><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ico_social_lastfm.png" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['profile_social_lastfm']; ?>
" border="0"> <?php echo $this->_tpl_vars['social_lastfm']; ?>
</a></li>
			<?php else: ?>
				<li><img src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
