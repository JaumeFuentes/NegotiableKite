	...
	<div id="bloque1" >
				...
				<div class="MainImageBox" id="display_image">
					...
					<table id="MainImageTable" cellspacing="0" cellpadding="0" border="0">
						<tr>    
							...
							<img src="imagenes/redimensionar.php?anchura=377&hmax=333&imagen=
        ...
        <img src="imagenes/redimensionar.php?imagen=<?php echo $las_webs->carga_imagen($codan,4);?>" alt = "Thumbnail 4" border="0"/></a>
			...
			<div class="datos_anuncio">
				...
				<div class="campos_info_anuncio">Nick: <span class="variab_anun">
					<a href="perfil.php?user=<?php echo $matriz_resultado[0]["nick"]; ?>" title="ver perfil de <?php echo $matriz_resultado[0]["nick"]; ?>">
